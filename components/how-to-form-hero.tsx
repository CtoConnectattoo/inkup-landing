            ...
            <div className="space-y-4">
              ...
              >
                <a href="https://hi.inkup.io/auth/signup" target="_blank" rel="noopener noreferrer">
                  Crear mi formulario ahora <ArrowRight className="ml-2 h-5 w-5" />
                </a>
              </Button>

              <p className="text-sm text-gray-500">
                ¿Ya sabes cómo funciona?{" "}
                <Link href="/crear-formulario-whatsapp" className="text-[#D7277D] hover:underline">
                  Ve directo al creador →
                </Link>
              </p>
            </div>
          </motion.div>
