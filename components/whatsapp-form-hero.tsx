...
export function WhatsAppFormHero() {
  return (
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Crea formularios sin código y recibe los datos directamente en tu WhatsApp ⚡
              </p>
            </div>
            ...
            <p className="text-sm text-gray-500 text-center">Sin tarjeta de crédito. Sin código requerido.</p>
          </motion.div>
              ...
              <div className="bg-[#E5DDD5] rounded-2xl shadow-2xl w-64 h-96 overflow-hidden relative">
                ...
                <div className="bg-[#075E54] text-white pt-6 pb-2 px-3 flex items-center gap-2">
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <div>
                      <p className="font-semibold text-sm">Maria Clienta</p>
