...
export function StudioFormHero() {
  return (
            ...
            <div className="space-y-6">
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-black">
                ...
                <span className="bg-gradient-to-r from-[#8B5CF6] to-[#D946EF] bg-clip-text text-transparent">
                  Gestiona tus artistas y clientes
                </span>{" "}
                desde un solo lugar
              </h1>
              <h2 className="text-2xl font-semibold text-gray-700">
                Software completo para estudios de tatuaje que centraliza consultas y gestiona múltiples artistas en
                Whatsapp
              </h2>
            </div>
            ...
            <div className="space-y-4">
              <Button size="lg" className="w-full h-14 text-lg bg-[#25D366] hover:bg-[#20BA5A] text-white" asChild>
                <a href="https://hi.inkup.io/auth/signup" target="_blank" rel="noopener noreferrer">
                  📱 Crea tu asistente en 1 minuto
                </a>
              </Button>
            </div>

            <p className="text-sm text-gray-500 text-center">
              Sin tarjeta de crédito. Gestiona múltiples artistas desde el primer día.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative">
              <Image
                ...
                alt="Dashboard para gestión de estudio de tatuaje"
                width={280}
                height={560}
                className="rounded-2xl shadow-2xl"
              />

              {/* Texto "Así gestionas tu estudio" - visible en mobile */}
              ...
              {/* Flecha apuntando al dashboard - solo desktop */}
              <div className="absolute -left-16 top-1/2 transform -translate-y-1/2 hidden lg:block">
                <div className="flex items-center gap-2">
                  <div className="bg-[#D7277D] text-white px-3 py-2 rounded-lg text-sm font-medium">¡Tu asistente!</div>
            ...
            <div className="relative">
                  ...
                  <div className="space-y-2 flex-1">
                    <div className="bg-white rounded-lg p-2 max-w-[85%] shadow-sm">
                      <p className="text-sm text-gray-800 leading-relaxed">
                        ...
                        <br />
                        <br />
                        <strong>Artista preferido:</strong> Carlos
                        <br />
              ...
              <div className="absolute -right-20 top-1/2 transform -translate-y-1/2 hidden xl:block">
                <div className="flex items-center gap-2">
                  ...
                  <div className="bg-[#25D366] text-white px-3 py-2 rounded-lg text-sm font-medium">
                    Así te llega a Whatsapp
                  </div>
                </div>
              </div>
